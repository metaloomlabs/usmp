...
2. Build the Arduino library zip by running `.\scripts\build-arduino-zip.ps1` in PowerShell (which outputs `usmp-1.3.0-arduino.zip`), or copy the `ports/usmp-arduino/` directory directly to your Arduino `libraries/USMP` folder.
